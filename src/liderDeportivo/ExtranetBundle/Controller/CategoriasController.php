...
use liderDeportivo\ExtranetBundle\Entity\Categorias;
use liderDeportivo\ExtranetBundle\Form\CategoriasType;
use liderDeportivo\ExtranetBundle\Form\CategoriasFilterType;
...
class CategoriasController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $filterForm = $this->createForm(new CategoriasFilterType());
        $em = $this->getDoctrine()->getManager();
        $queryBuilder = $em->getRepository('ExtranetBundle:Categorias')->createQueryBuilder('e');

        // Reset filter
        if ($request->get('filter_action') == 'reset') {
            $session->remove('CategoriasControllerFilter');
        }
        ...
        if ($request->get('filter_action') == 'filter') {
            ...
            if ($filterForm->isValid()) {
                ...
                $session->set('CategoriasControllerFilter', $filterData);
            }
        } else {
            // Get filter from session
            if ($session->has('CategoriasControllerFilter')) {
                $filterData = $session->get('CategoriasControllerFilter');
                $filterForm = $this->createForm(new CategoriasFilterType(), $filterData);
                $this->get('lexik_form_filter.query_builder_updater')->addFilterConditions($filterForm, $queryBuilder);
            }
        }
    ...
    */
    protected function paginator($queryBuilder)
    {
        ...
        {
            return $me->generateUrl('categorias', array('page' => $page));
        };
     ...
     * @Method("POST")
     * @Template("ExtranetBundle:Categorias:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ExtranetBundle:Categorias')->find($id);
        $atletas = $em->getRepository('ExtranetBundle:CategoriaAtleta')->findByCategoria($id);
     ...
     * @Method("PUT")
     * @Template("ExtranetBundle:Categorias:edit.html.twig")
     */
